...
public:
    ...
    PTR_CUTF8 GetMethodNameNonNull()
    {
        LIMITED_METHOD_DAC_CONTRACT;
        return RelativePointer<PTR_CUTF8>::GetValueAtPtr(PTR_HOST_MEMBER_TADDR(DynamicMethodDesc, this, m_pszMethodName));
    }
...
public:
    ...
    PTR_NDirectImportThunkGlue GetImportThunkGlue()
    {
        LIMITED_METHOD_DAC_CONTRACT;
        return RelativePointer<PTR_NDirectImportThunkGlue>::GetValueAtPtr(PTR_HOST_MEMBER_TADDR(NDirectMethodDesc, this, ndirect.m_pImportThunkGlue));
    }
...
public:
    ...
    PTR_DictionaryLayout GetDictLayout()
    {
        LIMITED_METHOD_DAC_CONTRACT;
    ...
    {
        LIMITED_METHOD_DAC_CONTRACT;
        return RelativePointer<PTR_MethodDesc>::GetValueMaybeNullAtPtr(PTR_HOST_MEMBER_TADDR(InstantiatedMethodDesc, this, m_pWrappedMethodDesc));
    }
