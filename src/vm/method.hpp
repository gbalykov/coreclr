...
public:
    ...
    {
        LIMITED_METHOD_DAC_CONTRACT;
        return m_pszMethodName.GetValueMaybeNull(dac_cast<TADDR>(this) + offsetof(DynamicMethodDesc, m_pszMethodName));
    }
    ...
    {
        LIMITED_METHOD_DAC_CONTRACT;
        return m_pszMethodName.GetValue(dac_cast<TADDR>(this) + offsetof(DynamicMethodDesc, m_pszMethodName));
    }
